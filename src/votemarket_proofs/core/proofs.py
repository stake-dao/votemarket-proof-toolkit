...
from votemarket_proofs.services.user_proof import generate_user_proof
from votemarket_proofs.services.gauge_proof import generate_gauge_proof
from votemarket_proofs.services.encoder import get_block_info
from votemarket_proofs.shared.constants import (
    GaugeVotesConstants,
    GlobalConstants,
)
from votemarket_proofs.services.web3_service import Web3Service
from votemarket_proofs.shared.exceptions import VoteMarketProofsException
from votemarket_proofs.shared.types import BlockInfo, GaugeProof, UserProof
from votemarket_proofs.shared.utils import get_rounded_epoch
