#!/usr/bin/env python3
"""
Example: Create a campaign on L2 from L1 using CCIP bridge.

This example demonstrates how to:
- Create a campaign on L2 (e.g., Arbitrum) from L1 (Ethereum)
...
# ABIs
ERC20_ABI = load_json("votemarket_toolkit/resources/abi/erc20.json")
...
def main():
    """Example usage of creating a campaign from L1."""
    print("=" * 70)
    print("Creating Campaign on L2 from L1 (via CCIP)")
    print("=" * 70)
    ...
    print(
        "\nNote: This transaction will bridge tokens from L1 to L2 using CCIP"
    )
