...
- Fetch multiple token prices efficiently in a single API call
- Get prices for tokens on different chains
- Handle token amounts with different decimals
...
def main():
    """Fetch and display token prices from multiple chains."""
