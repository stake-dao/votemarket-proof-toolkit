...
vm_yb_platforms: install
	$(PYTHON) src/votemarket_toolkit/external/vm_all_platforms.py yb --epoch 1762387200

vm_yb_active_proofs: install
	$(PYTHON) src/votemarket_toolkit/external/vm_active_proofs.py temp/all_platforms.json 1762387200
