...
VOTER = "0x52f541764e6e90eebc5c21ff570de0e2d63766b6"
...
""" # TODO : Fix; running indefinitely on Point Data extraction (contract side)
def test_gauge_proof(vm_proofs, setup_environment, curve_mock_verifier):
    votemarket = setup_environment["votemarket"]
    campaign = votemarket.getCampaign(setup_environment["campaign1_id"])
    gauge_address = campaign[1]

    gauge_controller_proof, point_data_proof = vm_proofs.get_gauge_proof(
        protocol="curve",
    ...
    # Set in the verifier
    block_header = curve_mock_verifier.decodeBlockHeader(
        ""
    )
    account_from_proof = curve_mock_verifier.extractGaugeControllerAccount(
        block_header["stateRootHash"].hex(),
        gauge_controller_proof,
    )

    state_root_hash = account_from_proof["storageRoot"].hex()


    print(point_data_proof.hex())

    # Proof for an account
    ...
    print(len(user_storage_proof.hex()))

    # Point Data
    point_data = curve_mock_verifier.extractPointData(
        gauge_address,
        PERIOD,
        state_root_hash,
        "0x" + point_data_proof.hex(),
    )
