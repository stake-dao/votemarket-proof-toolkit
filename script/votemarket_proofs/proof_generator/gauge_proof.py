...
def generate_gauge_proof(
    ...
    """
    point_weights_base_slot = ProofGeneratorConstants.GAUGES_SLOTS[protocol]["point_weights"]
    ...
    raw_proof = w3.eth.get_proof(
        w3.to_checksum_address(ProofGeneratorConstants.GAUGE_CONTROLLER[protocol].lower()),
        slots,
        block_number,
    )
